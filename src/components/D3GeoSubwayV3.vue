...
export default {
  ...
  async mounted() {
    ...
    gSubwayLayer.attr("transform","translate(0,0)")
       .append("use").attr("xlink:href","#subway_def");

    gSubwayParallelLayer.attr("transform","translate(0,14)")
       .append("use").attr("xlink:href","#subway_def");
    ...
    const zoomed = function() {
      ...
      gSubwayParallelLayer.attr("transform", d3.event.transform);
    }
