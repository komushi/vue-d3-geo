...
export default {
  ...
  async mounted() {
    ...
    // const gSubway = svg.append('g').attr("id", 'subway_group');
    // const defSubway = gSubway.append("defs").append("g").attr("id", "subway_def");
    // const gSubwayLayer = gSubway.append("g").attr("id", this.subwayObjects);
    // const gSubwayParallelLayer = gSubway.append("g").attr("id", this.subwayObjects + "_parallel");
    // const gSubwayLabelLayer = gSubway.append("g").attr("id", this.subwayObjects + "_label");

    const defSubway = svg.append('defs').attr('id', 'subway_def');
    const gSubway = svg.append('g').attr("id", 'subway');
    const gSubwayLayer = gSubway.append("g").attr("id", this.subwayObjects);
    const gSubwayLayer2 = gSubway.append("g").attr("id", this.subwayObjects + '_02');
    ...
    const maskSubway = defSubway.append('mask')
      .attr('id', 'subwayMask');

    maskSubway.append("rect")
      .attr("width", 2000)
      .attr("height", 2000)
      .attr("fill", "gray");

    maskSubway.selectAll("path")
      .data(subwayFeatures)
      .enter()
      .append("path")
      .attr("d", path)
    ...
    const pathSubway = gSubwayLayer.selectAll("path")
      .data(subwayFeatures)
      .enter()
      .append("path")
      .attr("d", path)
      ...
      .attr("stroke", "red")
      .attr("fill", "none")
      .attr("mask", "url(#subwayMask)");

    // const pathSubway2 = gSubwayLayer2.selectAll("path")
    //   .data(subwayFeatures)
    //   .enter()
    //   .append("path")
    //   .attr("d", path)
    ...
    const zoomed = function() {
      ...
      gSubwayLayer2.attr("transform", d3.event.transform);
    }
